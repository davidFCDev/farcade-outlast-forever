...
// Start Vite server with custom config and capture its output to detect the actual port
const viteProcess = spawn("npx", ["vite", "--config", "vite.config.dev-its.ts", "--host", "--port", port], {
